...
- Directional linguistic coordination is available through the `coordination` command and service operation, with support counts and a dependency-free default vocabulary.
